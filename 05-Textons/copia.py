...
folders.sort()
del folders[0]
n=20; #number of train and test images
tam=100 #size of squared images
...
#KNN - con chi2
#neigh= KNeighborsClassifier(n_neighbors=25,metric='pyfunc',func=chi2_kernel)
#neigh=neigh.fit(train_histo,label)
#resultado=neigh.predict(test_histo)
#aca= accuracy_score(label,resultado)

#RandomForest
clf = RandomForestClassifier(n_estimators=30, max_features=0.3,max_depth=15)
